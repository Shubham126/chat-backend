...
class ScrapingService {
    ...
    async scrapeWebsite(url, customConfig = {}) {
    ...
    async findAndScrapeRobots(domain) {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                const urls = this.parseRobots(response.data, domain);
    ...
    parseRobots(robotsData, domain) {
        ...
        for (const line of lines) {
            ...
            // IGNORE Sitemap directives - only use Allow directives
        ...
        return urls; // NO URL limits - scrape all discovered URLs
    }
